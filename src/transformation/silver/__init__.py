...
from src.transformation.silver.fatura_reclamada_sp import FaturaReclamadaSpSilverTransformer
from src.transformation.silver.medidor_sp import MedidorSpSilverTransformer
...
TRANSFORMER_REGISTRY = {
    ...
    "medidor_sp": MedidorSpSilverTransformer,
    "fatura_reclamada_sp": FaturaReclamadaSpSilverTransformer,
    **MASTER_TRANSFORMERS,
}
