...
KNOWN_QUESTION_SEEDS: tuple[KnownQuestionSeed, ...] = (
    ...
    KnownQuestionSeed(
        ...
        (
            ...
            "Quais os medidores existentes em SP",
        ),
        "analise_dados",
        "SP",
    ...
    KnownQuestionSeed(
        ...
        (
            ...
            "Quais os medidores em SP que mais dão problema e qual é o tipo de reclamação que eles mais geram",
        ),
        "analise_dados",
        "SP",
        (
    ...
    KnownQuestionSeed(
        "sp-invoice-meter-profile",
        (
            "Qual é o valor médio das faturas com reclamação que envolvem digitação em SP ?",
            "Quais são as faturas com valor mais alto ? E de quais instalações elas são e de que data ?",
            "Cruze a fatura com o tipo de medidores em SP",
            "Cruze fatura reclamada com tipo de medidor em SP",
            "Quanto tempo demorou da emissão da fatura até a reclamação em SP?",
            "Quanto tempo demorou pra solucionar a reclamação?",
            "Qual a data da fatura reclamada e o valor por instalação em SP?",
            "Qual o valor médio de fatura por tipo de medidor em SP?",
        ),
        "analise_dados",
        "SP",
        (
